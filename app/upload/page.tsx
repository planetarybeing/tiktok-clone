            ...
            <UploadLayout>
                <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
                    <div>
                        ...
                        <h2 className="text-gray-600 mt-1">Post a video to your account</h2>
                    </div>
                    ...
                    <div className="mt-8 md:flex gap-6">
                        ...
                        {!fileDisplay ? 
                            ...
                            >
                                ...
                                <p className="mt-2 text-gray-400 text-[13px]">Up to 10 minutes</p>
                                <p className="mt-2 text-gray-400 text-[13px]">Less than 1 GB</p>
                                <label 
                                    htmlFor="fileInput" 
                                    className="px-2 py-1.5 mt-8 text-white text-[15px] w-[80%] bg-[#9f00ff] rounded-sm cursor-pointer"
                                >
                                    Select file
                                </label>
                                <input 
                        ...
                        <div className="mt-4 mb-6">
                            <div className="flex bg-[#F8F8F8] py-4 px-6">
                                ...
                                <div>
                                    ...
                                    Split into multiple parts to get more exposure
                                    </div>
                                </div>
                                <div className="flex justify-end max-w-[130px] w-full h-full text-center my-auto">
                                    <button className="px-8 py-1.5 text-white text-[15px] bg-[#9f00ff] rounded-sm">
                                        Edit
                                    </button>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-3">
                                ...
                                <button 
                                    ...
                                    className="px-10 py-2.5 mt-8 border text-[16px] text-white bg-[#9f00ff] rounded-sm"
                                >
